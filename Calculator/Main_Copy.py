...
class GraphWindow(qtw.QWidget):
    ...
    def setup_settings_bloc(self):
        ...
        btn_mins_max=qtw.QPushButton('MIN/MAX',clicked=lambda:self.mins_and_maxs())
        btn_intersect=qtw.QPushButton('INTERSECT',clicked=lambda:self.find_intersections())
        btn_zeros=qtw.QPushButton('ZEROS',clicked=lambda:self.find_zeros())
    ...
    def plot(self,f,f_name,f_org,flag,color,error):
        ...
        self.store_function(f_org,color,f_name,flag,error)
    ...
    '''Storage and History'''
    def store_function(self,f_org,color,f_name,flag,error): # add storage of the expression you are actually computationally graphing
        self.function_storage.append([f_org,color,f_name,flag])
    ...
    def intersection(self,funct_list):
        coordinate_list=[]
